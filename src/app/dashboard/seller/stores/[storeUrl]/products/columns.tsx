...
export const columns: ColumnDef<StoreProductType>[] = [
    {
        // Changed this to name to make sure the search function works
        accessorKey: "name",
        header: "",
        cell: ({ row }) => {
            return (
                                ...
                                <div key={variant.id} className="flex flex-col gap-y-2">
                                    <div className="relative cursor-pointer">
                                        ...
                                        <div className="flex mt-2 gap-2 p-1">
                                            {/* Colors */}
                                            <div className="w-7 grid grid-cols-2 gap-5 gap-y-1 rounded-md">
                                            ...
                                            <div>
                                                {/* Name of variant */}
                                                <h1 className="max-w-40 capitalize text-sm ml-4">
                                                    Variant name: {variant.variantName}
                                                </h1>
                                                {/* Sizes */}
                                                <div className="flex flex-wrap gap-5 max-w-72 mt-1 ml-3">
            ...
            <AlertDialogContent className="max-w-lg">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-left">
                        ...
                        product and variants of the product.
                    </AlertDialogDescription>
                </AlertDialogHeader>
