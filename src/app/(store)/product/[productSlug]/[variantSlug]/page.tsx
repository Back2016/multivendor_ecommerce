...
export default async function ProductVariantPage({ params, searchParams }: PageProps,) {
  ...
  // If no product data is found, redirect to main product
  if (!productData) {
  ...
  console.log("store", productData.store);
          ...
          <div>
            {relatedProducts.products && (
              <>
                <Separator />
                {/* Related products */}
                <RelatedProducts products={relatedProducts.products} selfId={productId} />
              </>
            )}
