...
const ImageUpload: FC<ImageUploadProps> = ({
    ...
    if (type === "profile") {
        ...
        return (
            ...
            >
                {
                    value.length > 0 && <Image src={value[0]} alt="" width={1200} height={1200} className="w-full h-full rounded-lg object-cover" />
                }
                <div style={{ pointerEvents: "auto" }}>
                    <CldUploadWidget
                        uploadPreset={cloudinary_preset}
                        ...
                        {({ open }) => {
                            ...
                            return (
                                <>
                                    <button
                                        type="button"
                                        className="absolute bottom-4 right-4 flex items-center font-medium text-[17px] py-3 px-6 text-white bg-gradient-to-t from-[var(--blue-primary)] to-blue-300 border-none shadow-lg rounded-full hover:shadow-md active:shadow-sm"
                                        disabled={disabled}
                                        onClick={onClick}
                                    >
                                        <svg
                        ...
                        {({ open }) => {
                            ...
                            return (
                                <>
                                    <button
                                        type="button"
                                        className="flex items-center font-medium text-[17px] py-3 px-6 text-white bg-gradient-to-t from-[var(--blue-primary)] to-blue-300 border-none shadow-lg rounded-full hover:shadow-md active:shadow-sm"
                                        disabled={disabled}
                                        onClick={onClick}
                                    >
                                        <svg
