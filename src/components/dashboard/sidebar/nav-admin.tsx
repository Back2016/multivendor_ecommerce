        ...
        <nav className="relative grow">
            <Command className="rounded-lg overflow-visible bg-transparent">
                ...
                <CommandList className="py-2 overflow-visible">
                    ...
                    <CommandGroup className="overlow-visible pt-0 relative">
                        {menuLinks.map((link, index) => {
                            ...
                            return <CommandItem key={index} className={cn("w-full h-12 cursor-pointer mt-1", {
                                ...
                                <Link href={link.link} className="flex items-center gap-2 hover: bg-transparent rounded-m transition-all w-full">
                                    {icon}
