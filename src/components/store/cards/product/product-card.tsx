      ...
      >
        <div className="relative w-full h-full">
          ...
          >
            ...
            {/* Title */}
            <div className="text-sm text-[var(--main-primary)] h-[18px] overflow-hidden overflow-ellipsis line-clamp-1">
              {name} · {variantName}
            </div>
            {/* Rating - Sales */}
            {product.rating > 0 && product.sales > 0 && (
              <div className="flex items-center gap-x-1 h-5">
                <ReactStars
                  ...
                  filledIcon={<FaStar />}
                />
                <div className="text-xs text-[var(--main-secondary)]">{sales} sold</div>
              </div>
            )}
            {/* Price */}
