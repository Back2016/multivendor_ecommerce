      ...
      <div className="flex h-11 items-center px-2 cursor-pointer">
        ...
        <div className="ml-1">
          <b className="max-w-[90px] inline-block font-medium text-xs text-white">
            Download the NextShop app
          </b>
        </div>
      </div>
      {/* Content */}
      <div className="absolute hidden top-0 group-hover:block cursor-pointer">
        <div className="relative mt-12 -ml-20 w-[300px] bg-white rounded-3xl text-[var(--main-primary)] pt-2 px-1 pb-6 z-50 shadow-lg">
          {/* Traingle */}
          <div
          ...
          <div className="py-3 px-1 break-words">
            <div className="flex">
              <div className="mx-3">
                <h3 className="font-bold text-[20px] text-[var(--main-primary)] m-0 max-w-40 mx-auto">
                  Download the NextShop app
                </h3>
                <p className="text-center"> This is a demo project (Mobile App Dev in progress) </p>
