...
export default async function UserMenu() {
    const user = await currentUser();                // runs only on the server
    ...
    return <UserMenuClient user={safeUser} />;
}
...
//         )}
//       >
//         <div className="relative left-2 mt-10 right-auto bottom-auto pt-2.5 text-[var(--usermenu-text)] p-0 text-sm z-40">
//           {/* Triangle */}
...
//           {/* Menu */}
//           <div className="rounded-3xl bg-[var(--white)] text-sm text-[var(--usermenu-text)] shadow-lg">
...
//                     <Link
//                       href="/sign-up"
//                       className="h-10 text-sm hover:underline text-[var(--main-primary)] flex items-center justify-center cursor-pointer"
//                     >
//                       Register
//                     </Link>
//                   </div>
//                 )}
//                 {user && (
//                   <p className="my-3 text-center text-sm text-[var(--main-primary)] cursor-pointer">
//                     <SignOutButton />
//                   </p>
//                 )}
//                 <Separator />
//               </div>
//               {/* Links */}
//               <div className="max-w-[calc(100vh-180px)] text-[var(--main-secondary)] overflow-y-auto overflow-x-hidden pt-0 px-2 pb-4">
...
//                         <div className="w-14 h-14 rounded-full p-2 grid place-items-center bg-[var(--gray-light)] hover:bg-gray-200">
...
//                         <a className="block text-sm text-[var(--main-primary)] py-1.5 hover:underline">
//                           {item.title}
//                         </a>
//                       </Link>
//                     </li>
