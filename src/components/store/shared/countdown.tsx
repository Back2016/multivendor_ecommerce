...
const Countdown: FC<Props> = ({ targetDate, home_style }) => {
  ...
  if (isZero) return <div />;


  return (
    <div
      className={cn("text-[var(--orange-background)] bg-gray-200 leading-4 p-1 rounded", {
    ...
    >
      ...
      >
        ...
        <div className="inline-block">
          <span
            className={cn(
              "bg-[var(--orange-background)] text-white min-w-5 p-0 rounded-[2px] inline-block min-h-4 text-center",
              {
