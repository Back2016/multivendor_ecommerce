...
const ProductPrice: FC<Props> = ({ sizeId, sizes, isCard, handleChange }) => {
  ...
  if (!sizeId) {
    ...
    return (
      <div>
        <div className="text-[var(--orange-primary)] inline-block font-bold leading-none mr-2.5">
          <span
        ...
        {!sizeId && !isCard && (
          <div className="text-[var(--orange-background)] text-xs leading-4 mt-1">
  ...
  return (
    <div>
      ...
      {selectedSize.discount > 0 && (
        <span className="inline-block text-[var(--orange-secondary)] text-xl leading-6">
